            ...
            <div className = 'grid grid-cols-[repeat(auto-fit,minmax(200px,1fr))] my-10 gap-5'>
                {workData.map((project , index) => (
                    ...
                    style = {{backgroundImage: `url(${project.bgImage})`}}>
                        <div className = 'bg-white w-10/12 rounded-md absolute bottom-5 left-0.5 -translate-x-0.5 py-3 px-5 flex items-center justify-between duration-500 group-hover:bottom-7'>
                            <div>
